...
st.markdown("<h2 style='text-align: center; color: white;'><b> -- Smart Music Recommender -- </b></h2>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; color: white;'><b>''Hey there!👋''</b></h3>", unsafe_allow_html=True)
